...
{
public:
    EntropyCalibratorImpl(BatchStream& stream, int firstBatch, const char* networkName, const char* inputBlobName, bool readCache = true)
        : mStream(stream)
...
//! 
//! \brief Implements Legacy Entropy calibrator. 
//!  CalibrationAlgoType is kENTROPY_CALIBRATION.
//!
class Int8EntropyCalibrator : public IInt8EntropyCalibrator
{
public:
    Int8EntropyCalibrator(BatchStream& stream, int firstBatch, const char* networkName, const char* inputBlobName, bool readCache = true)
